...
アバタールートについている`LocomotionAnimationHandMetrics`の値を調節しましょう。これは移動時にアバターの**腕**をフワフワ動かすための設定を記入するコンポーネントです。

![LocomotionAnimationHandMetrics](LocAnimHandMet.webp)
<small>`HandOffset`と`ArmLength`の値を変えよう</small>


![まっすぐになったマヌカ](manuka-udemassugu.webp)
<small>腕が落ち着いたね</small>
